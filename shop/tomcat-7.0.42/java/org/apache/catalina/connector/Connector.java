...
public class Connector extends LifecycleMBeanBase {
	...
	public static final boolean RECYCLE_FACADES = Boolean
			.valueOf(System.getProperty("org.apache.catalina.connector.RECYCLE_FACADES", "false")).booleanValue();
	...
	public Connector(String protocol) {
		...
		try {
			...
			this.protocolHandler = (ProtocolHandler) clazz.newInstance();// 反射创建protocolHandler 默认 http1.1 协议实现
	...
	/**
	 * Return the maximum size of a POST which will be saved by the container during
	 * authentication.
	 */
	 ...
	 * requests. The special value of 0 means select a random free port when the
	 * socket is bound.
	 */
	public int getPort() {
	 ...
	 * the special value for {@link #port} of zero is used then this method will
	...
	/**
	 * Set the class name of the Coyote protocol handler which will be used by the
	 * connector.
	 *
	 ...
	 *
	 * @return true if generation of X-Powered-By response header is enabled, false
	 *         otherwise
	 */
	...
	protected void initInternal() throws LifecycleException {
		System.out.println("**********=====>"+getPort()+"初始化连接器");
		super.initInternal();
