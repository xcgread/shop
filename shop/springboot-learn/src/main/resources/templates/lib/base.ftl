...
<#macro pageBase currentMenu skinid=skinid>
<@head.htmlBase skinid/>
<body>
<!-- Themer -->  
	<div id="mws-themer">
        ...
        <div id="mws-sidebar">
            ...
            <div id="mws-navigation">
				...
				<#list userMenus as menu>
						<li class="${(currentMenu==menu.name)?string('active','')}"><a href="<#if menu.children?? && menu.children?size gt 0>#<#else>${request.contextPath}${menu.url}</#if>" class="${menu.icon!}">${menu.name!}</a>
						<#if menu.children?? && menu.children?size gt 0>
							<ul>
									<#list menu.children as menu>
										<li class="${(currentMenu==menu.name)?string('active','')}"><a href="${request.contextPath}${menu.url}">${menu.name!}</a></li>
									</#list>
							</ul>
						</#if>
						</li>
