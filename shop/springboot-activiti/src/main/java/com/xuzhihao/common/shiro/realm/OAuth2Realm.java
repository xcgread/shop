...
import com.xuzhihao.common.api.ShiroUtil;
import com.xuzhihao.common.api.WebHelper;
import com.xuzhihao.common.shiro.OAuth2Helper;
import com.xuzhihao.common.shiro.token.OAuth2Token;
import com.xuzhihao.system.model.User;
import com.xuzhihao.system.model.UserAuths;
import com.xuzhihao.system.service.UserAuthsService;
...
public abstract class OAuth2Realm extends AuthenticatingRealm {
	...
	/**
	 * 调用方法： {@link #getAuthcTypeEnum} 获取认证类型. 用来判断该 Realm 是否用来处理此认证类型. 并获取该类型对应的
	 * clientId 和 clientSecret 和 redirectUrl.
	 */
	@Override
	...
	protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken token) throws AuthenticationException {
		...
		if (isAuthenticated) {
			userAuths = userAuthsService.selectOneByIdentityTypeAndUserId(getAuthcTypeEnum(),
					ShiroUtil.getCurrentUser().getUserId());
		} else {
			userAuths = userAuthsService.selectOneByIdentityTypeAndIdentifier(getAuthcTypeEnum(),
