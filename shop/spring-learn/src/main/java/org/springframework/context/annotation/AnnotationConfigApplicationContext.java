 ...
 * &mdash; in particular {@link Configuration @Configuration}-annotated classes,
 * but also plain {@link org.springframework.stereotype.Component @Component}
 * types and JSR-330 compliant classes using {@code javax.inject} annotations.
 *
 * <p>
 ...
 *
 * <p>
 * In case of multiple {@code @Configuration} classes, {@link Bean @Bean}
 ...
 * definitions via an extra {@code @Configuration} class.
 *
 * <p>
...
public class AnnotationConfigApplicationContext extends GenericApplicationContext implements AnnotationConfigRegistry {
	 ...
	 * through {@link #register} calls and then manually {@linkplain #refresh
	 * refreshed}.
	 */
	...
	/**
	 * Create a new AnnotationConfigApplicationContext, scanning for components in
	 * the given packages, registering bean definitions for those components, and
	...
	/**
	 * Set the {@link ScopeMetadataResolver} to use for registered component
	 * classes.
	 * <p>
