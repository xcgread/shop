...
public class RedisClient {
	...
	public void start() throws Exception {
		...
		try {
			...
			bootstrap.group(group).channel(NioSocketChannel.class).handler(new RedisClientInitializer());
	...
	public static void main(String[] args) throws Exception {
		RedisClient client = new RedisClient("172.17.17.80", 6379);
		client.start();
	}
